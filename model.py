...
class DQN(nn.Module):
    """ The model architecture as presented in doi:10.1038/nature14236
            Args: 
                ...
                n_actions (int): number of actions the network can perform
                input_image_size (tuple): a tuple consisting of the width and
                height of the imput image. Default=(84, 84)
    """
    def __init__(self, input_channels, n_actions, input_image_size=(84, 84)):
        ...
        fc_input_len = self.calc_fc_input_size(input_channels, input_image_size)
        self.fc1 = nn.Linear(fc_input_len, 512)
        self.fc2 = nn.Linear(512, n_actions)


    def calc_fc_input_size(self, channels, image_size):
